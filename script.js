...
let favoriteFoods = ["Pasta", "Tacos", "Wings", "Burgers", "Bagels", "Pancakes"];
...
console.log("Long food names array:", longFoodNames);
console.log("Short food names array:", shortFoodNames);
